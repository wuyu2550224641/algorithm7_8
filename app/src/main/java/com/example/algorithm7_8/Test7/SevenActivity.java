...
public class SevenActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.task1Btn:
                Intent intent = new Intent(SevenActivity.this,SevenT1Activity.class);
                startActivity(intent);
                break;
            case R.id.task2Btn:
                Intent intent1 = new Intent(SevenActivity.this,SevenT2Activity.class);
                startActivity(intent1);
                break;
            case R.id.task3Btn:
                Intent intent2 = new Intent(SevenActivity.this,SevenT3Activity.class);
                startActivity(intent2);
                break;
            case R.id.returnBtn:
                Intent intent3 = new Intent(SevenActivity.this, MainActivity.class);
